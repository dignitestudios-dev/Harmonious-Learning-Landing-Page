...
export default function SpecialSection() {
  return (
    <section className="py-0 relative lg:px-8">
      <div
        className="
      max-w-7xl 
      relative 
    ...
    "
      >
        {/* Heading */}
        <div className="py-2 md:mt-30 lg:w-[655px] mb-2 w-full px-4 sm:px-6">
          <h2
            className="
          font-bold 
          text-white 
      ...
      "
        >
          {/* Left Column */}
          <div className="w-full pb-5 md:pb-10 lg:pb-3 px-4 sm:px-6  flex flex-col lg:gap-20 lg:bg-none bg-linear-to-b from-black/30 to-black/80">
          ...
          {/* Right Column */}
          <div className="w-full px-4 sm:px-6 lg:px-0 lg:bg-transparent bg-black/80">
            {/* Card 001 */}
